  ...
  const teachers = await Promise.all([
    prisma.teacher.upsert({
      ...
      update: {
        ...
        photo: '/teachers/anna-kovaleva.png',
      },
      create: {
        id: 'teacher-1',
        name: 'Анна Ковалева',
        bio: 'Кандидат психологических наук, клинический психолог с более чем 12-летним опытом. Специализируется на работе с тревожными расстройствами и депрессией.',
        specialization: 'клинический психолог',
        photo: '/teachers/anna-kovaleva.png',
        sortOrder: 1,
      },
    ...
    prisma.teacher.upsert({
      ...
      update: {
        ...
        photo: '/teachers/maria-lebedeva.jpg',
      },
      create: {
        id: 'teacher-2',
        name: 'Мария Лебедева',
        bio: 'Психолог-консультант с международной сертификацией. Специализируется на работе с тревожными расстройствами и межличностными конфликтами.',
        specialization: 'психолог-консультант',
        photo: '/teachers/maria-lebedeva.jpg',
        sortOrder: 2,
      },
    ...
    prisma.teacher.upsert({
      ...
      update: {
        ...
        photo: '/teachers/dmitry-sokolov.png',
      },
      create: {
        id: 'teacher-3',
        name: 'Дмитрий Соколов',
        bio: 'Когнитивно-поведенческий терапевт, действительный член Российской Ассоциации КПТ. Более 10 лет работает с паническими атаками, ОКР и социальной тревогой.',
        specialization: 'когнитивно-поведенческий терапевт',
        photo: '/teachers/dmitry-sokolov.png',
        sortOrder: 3,
      },
    ...
    prisma.teacher.upsert({
      ...
      update: {
        ...
        photo: '/teachers/elena-vlasova.png',
      },
      create: {
        id: 'teacher-4',
        name: 'Елена Власова',
        bio: 'Семейный психолог и системный терапевт. Специализируется на работе с парами и детско-родительскими отношениями.',
        specialization: 'семейный психолог',
        photo: '/teachers/elena-vlasova.png',
        sortOrder: 4,
      },
